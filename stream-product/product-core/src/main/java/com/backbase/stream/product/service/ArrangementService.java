...
public class ArrangementService {
  ...
  private final com.backbase.dbs.arrangement.api.integration.v2.ArrangementsApi
  ...
  public Mono<ArrangementItem> createArrangement(PostArrangement postArrangement) {
    ...
    return arrangementsIntegrationApi
        .postArrangements(postArrangement)
        .doOnError(
  ...
  public Mono<ArrangementPutItem> updateArrangement(
      String arrangementId, ArrangementPutItem arrangementPutItem) {
    ...
    return arrangementsApi
        .putArrangementById(arrangementId, arrangementPutItem)
        .doOnEach(
            aVoid ->
                log.info("Updated Arrangement: {}", arrangementPutItem.getExternalArrangementId()))
                ...
                error(
                    new ArrangementUpdateException(
                        ...
                        "Failed to update Arrangement: "
                            + arrangementPutItem.getExternalArrangementId())));
  }

  public Flux<BatchResponseItemExtended> upsertBatchArrangements(
      List<PostArrangement> arrangementItems) {
    return arrangementsIntegrationApi
        .postBatchUpsertArrangements(arrangementItems)
        .<BatchResponseItemExtended>handle(
            (r, sink) -> {
              log.info(
                  "Batch Arrangement update result for arrangementId: {}, resourceId: {}, action: {}, result: {}",
                  r.getArrangementId(),
                  r.getResourceId(),
                  r.getAction(),
                  r.getStatus());
              ...
              if (!BatchResponseStatusCode.HTTP_STATUS_OK.equals(r.getStatus())) {
                ...
                sink.error(
                    new IllegalStateException(
                        "Batch arrangement update failed: '%s'; errors: %s"
                            .formatted(
                                r.getResourceId(),
                                join(",", errors.stream().map(ErrorItem::toString).toList()))));
                return;
              }
              sink.next(r);
            })
  ...
  public Flux<ArrangementItem> getArrangementByExternalId(List<String> externalId) {
    ...
    return arrangementsApi
        .postSearchArrangements(arrangementsSearchesPostRequest)
    ...
    return arrangementsApi
        ...
        .doOnNext(
            response -> {
              ...
              log.info(
                  "Found Arrangement internalId: {} for externalId: {}", internalId, externalId);
            })
        .onErrorResume(
            WebClientResponseException.NotFound.class,
            notFound -> {
        ...
        .map(
            arrangementSearchesListResponse ->
                arrangementSearchesListResponse.getArrangementElements().stream()
  ...
  public Mono<String> deleteArrangementByExternalId(String arrangementExternalId) {
    ...
    return arrangementsApi
        .postDelete(arrangementsDeleteItemSet)
        .filter(
            arrangementsDeleteResponseElement ->
                EXTERNAL_ID
                    .getValue()
                    .equals(arrangementsDeleteResponseElement.getSelector().getValue()))
  ...
  public Mono<Void> addLegalEntitiesForArrangement(
    ...
    return arrangementsIntegrationApi.postArrangementLegalEntities(
        arrangementExternalId,
        new ExternalLegalEntityIds().ids(new HashSet<>(legalEntitiesExternalIds)));
  }
  ...
  public Mono<Void> removeLegalEntityFromArrangement(
    ...
    return arrangementsIntegrationApi.deleteArrangementLegalEntities(
        arrangementExternalId,
