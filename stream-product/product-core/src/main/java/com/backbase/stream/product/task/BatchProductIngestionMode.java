...
public class BatchProductIngestionMode {
    ...
    /**
     * @return True, if function groups should be replaced (function groups not existing in batch
     *     will be REMOVED from DBS). Otherwise, they should be just updated.
     */
    ...
    /**
     * UPSERT - Function groups will be INSERTED/UPDATED. REPLACE - Function groups will be
     * REPLACED.
     */
