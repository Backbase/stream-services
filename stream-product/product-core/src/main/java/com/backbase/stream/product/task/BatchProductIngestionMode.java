...
/**
 * Batch product ingestion mode. Keeps settings for three main resources involved in the process: - Function groups -
 * Data groups - Arrangements
 *
 * <p>Ingestion mode for each of those can be configured separately.
 */
@Builder
@AllArgsConstructor
public class BatchProductIngestionMode {
    ...
    /**
     * @return True, if function groups should be replaced (function groups not existing in batch will be REMOVED from
     * DBS). Otherwise, they should be just updated.
     */
    ...
    /**
     * @return True, if data groups should be replaced (data group and data group items not existing in batch will be
    ...
    /**
     * UPSERT - Function groups will be INSERTED/UPDATED. REPLACE - Function groups will be REPLACED.
     */
    ...
    /**
     * UPSERT - Data groups will be INSERTED/UPDATED. REPLACE - Data groups will be REPLACED.
     */
    ...
    /**
     * UPSERT - Arrangements will be INSERTED/UPDATED. REPLACE - Arrangements will be REPLACED.
     */
