 ...
 * Function groups - Data groups - Arrangements
 *
...
public class BatchProductIngestionMode {
  ...
  /**
   * @return True, if function groups should be replaced (function groups not existing in batch will
   *     be REMOVED from DBS). Otherwise, they should be just updated.
   */
  ...
  /**
   * @return True, if data groups should be replaced (data group and data group items not existing
   *     in batch will be REMOVED from DBS). Otherwise, they should be just updated.
   */
