...
class ProductMapperTest {
  ...
  private void buildBaseProduct(BaseProduct baseProduct) {
    baseProduct
        ...
        .legalEntities(
            List.of(
                buildLegalEntityReference("le_ext_id_1"), buildLegalEntityReference("le_ext_id_2")))
        ...
        .interestDetails(
            (InterestDetails) new InterestDetails().annualPercentageYield(new BigDecimal("12.5")))
        .overdueSince(LocalDate.of(2022, 11, 2))
        .debitCardsItems(
            List.of(new DebitCardItem().cardId("card_1"), new DebitCardItem().cardId("card_2")));
  }
  ...
  void map_AccountArrangementItem_To_Product() {
    ArrangementItem source =
        productMapper.toArrangementItem(productMapper.toPresentation(buildProduct()));
  ...
  void map_TermUnit_To_TimeUnit() {
    ...
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.D,
        productMapper.map(TermUnit.DAILY));
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.W,
        productMapper.map(TermUnit.WEEKLY));
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.M,
        productMapper.map(TermUnit.MONTHLY));
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.Y,
        productMapper.map(TermUnit.YEARLY));
  }
  ...
  void map_InterestPaymentFrequencyUnit_To_TimeUnit() {
    ...
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.D,
        productMapper.map(InterestPaymentFrequencyUnit.DAILY));
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.W,
        productMapper.map(InterestPaymentFrequencyUnit.WEEKLY));
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.M,
        productMapper.map(InterestPaymentFrequencyUnit.MONTHLY));
    Assertions.assertEquals(
        com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.Y,
        productMapper.map(InterestPaymentFrequencyUnit.YEARLY));
  }
  ...
  void map_TimeUnit_TermUnit() {
    Assertions.assertEquals(
        TermUnit.DAILY,
        productMapper.map(com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.D));
    Assertions.assertEquals(
        TermUnit.WEEKLY,
        productMapper.map(com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.W));
    Assertions.assertEquals(
        TermUnit.MONTHLY,
        productMapper.map(com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.M));
    Assertions.assertEquals(
        TermUnit.YEARLY,
        productMapper.map(com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.Y));
  }
  ...
  void map_TimeUnit_To_InterestPaymentFrequencyUnit() {
    ...
    Assertions.assertEquals(
        InterestPaymentFrequencyUnit.DAILY,
        productMapper.mapInterestPayment(
            com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.D));
    Assertions.assertEquals(
        InterestPaymentFrequencyUnit.WEEKLY,
        productMapper.mapInterestPayment(
            com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.W));
    Assertions.assertEquals(
        InterestPaymentFrequencyUnit.MONTHLY,
        productMapper.mapInterestPayment(
            com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.M));
    Assertions.assertEquals(
        InterestPaymentFrequencyUnit.YEARLY,
        productMapper.mapInterestPayment(
            com.backbase.dbs.arrangement.api.integration.v2.model.TimeUnit.Y));
  }
  ...
  void mapLegalEntityId() {
    ...
    List<LegalEntityReference> legalEntityReferenceList =
        List.of(buildLegalEntityReference("leid_1"), buildLegalEntityReference("leid_2"));
    ...
    Assertions.assertEquals(
        legalEntityIdList.size(), productMapper.mapLegalEntityReference(legalEntityIdList).size());
  }
}
