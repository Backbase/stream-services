    ...
    public Mono<ServiceAgreement> getMasterServiceAgreementForExternalLegalEntityId(
        ...
        return legalEntitiesApi
                ...
                .onErrorResume(
                        ...
                        throwable -> {
                            log.info(
                                    "Master Service Agreement not found for: {}. Request:[{}] {} "
                                            + " Response: {}",
                                    legalEntityExternalId,
    ...
    private String getAccessControlAccessToken() {
        try {
            SecretKeySpec secretKeySpec =
                    new SecretKeySpec(
                            accessControlApiTokenKey.getBytes(StandardCharsets.UTF_8), "AES");
            IvParameterSpec iv =
                    new IvParameterSpec(
                            accessControlApiTokenInitPhrase.getBytes(StandardCharsets.UTF_8));
                        ...
                        exception ->
                                Mono.error(
                                        new RuntimeException(
                                                "Failed to update Legal Entity", exception)))
                .onErrorStop()
