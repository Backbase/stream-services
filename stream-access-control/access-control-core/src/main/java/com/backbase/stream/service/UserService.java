...
public class UserService {
    ...
    /**
     * Archive users. As it is not possible to remove users from DBS, to be able to remove Legal Entity user external ID
     * is being updated to random value. (REMOVED_<external_id>_UUID) This step is required to be able re-ingest user
     * with same external id again.
     *
