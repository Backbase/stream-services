...
public class ArrangementManagerClientConfig extends CompositeApiClientConfig {
    ...
    @Bean
    @ConditionalOnMissingBean
    public com.backbase.dbs.arrangement.api.integration.ApiClient arrangementManagerIntegrationApiClient(ObjectMapper objectMapper, DateFormat dateFormat) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public com.backbase.dbs.arrangement.api.integration.v2.ArrangementsApi arrangementsIntegrationApi(com.backbase.dbs.arrangement.api.integration.ApiClient arrangementManagerIntegrationApiClient) {
