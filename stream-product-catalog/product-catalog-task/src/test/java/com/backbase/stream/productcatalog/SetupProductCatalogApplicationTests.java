...
public class SetupProductCatalogApplicationTests {
  ...
  public void testRepository() throws JsonProcessingException {
    ...
    productCatalog.addProductTypesItem(
        createProductType(
            "guided-investment-account", "Guided Investment Account", investmentAccount));
    productCatalog.addProductTypesItem(
        createProductType(
    ...
    // Term Deposit
    productCatalog.addProductTypesItem(
        createProductType("term-deposit-5", "Term Deposit 5 years", termDeposit));
    productCatalog.addProductTypesItem(
        createProductType("term-deposit-10", "Term Deposit 10 years", termDeposit));

    // Custom Product Types
    productCatalog.addProductTypesItem(
        createProductType("travel-insurance", "Travel Insurance", insurance));
    productCatalog.addProductTypesItem(
        createProductType("home-insurance", "Home Insurance", insurance));
