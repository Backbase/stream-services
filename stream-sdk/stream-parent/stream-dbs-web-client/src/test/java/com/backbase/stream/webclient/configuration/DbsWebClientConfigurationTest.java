        ...
        contextRunner
                ...
                .run(
                        context -> {
                            ...
                            assertThat(context)
                                    .getBean(WebClientConstants.INTER_SERVICE_WEB_CLIENT_NAME)
    ...
    public void shouldCreateFallbackClientRegistrationWithOverriddenTokenUriTest() {
        contextRunner
                ...
                .run(
                        context -> {
                            var tokenUri =
                                    context.getBean(ReactiveClientRegistrationRepository.class)
                                            .findByRegistrationId(
                                                    WebClientConstants.DEFAULT_REGISTRATION_ID)
                                            .block()
                                            .getProviderDetails()
                                            .getTokenUri();
                ...
                .run(
                        context -> {
                            ...
                            Assertions.assertEquals(
                                    "http://my-custom-endpoint/oauth/token", tokenUri);
                        });
    }
                ...
                .run(
                        context -> {
                            ...
                            Assertions.assertTrue(
                                    defaultRegistration.isEmpty(),
                                    "It should not create the default registration id.");

                            var tokenUri =
                                    repository
                                            .findByRegistrationId("dbs")
                                            .block()
                                            .getProviderDetails()
                                            .getTokenUri();
                            Assertions.assertEquals(
