...
@ConditionalOnProperty(
        value = {"spring.sleuth.enabled", "spring.zipkin.enabled", "spring.sleuth.task.enabled"},
        matchIfMissing = true)
public class TaskZipkinLifecycleAutoConfiguration {
    ...
    /**
     * Listener to the ApplicationReadyEvent once it is published at the end of the spring cloud
     * task execution.
     *
     * @param postProcessor .
     * @return .
