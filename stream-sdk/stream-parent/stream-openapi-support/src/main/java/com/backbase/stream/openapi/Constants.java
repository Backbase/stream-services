...
public final class Constants {
    ...
    public static final String API_DOCS_URL = "${backbase.api-docs.path:#{T(com.backbase.stream.openapi.Constants).DEFAULT_API_DOCS_URL}}";
    public static final String WEB_JARS_PREFIX_URL = "${backbase.webjars.prefix:#{T(com.backbase.stream.openapi.Constants).DEFAULT_WEB_JARS_PREFIX_URL}}";
    ...
    public static final String SWAGGER_UI_PATH = "${backbase.swagger-ui.path:#{T(com.backbase.stream.openapi.Constants).DEFAULT_SWAGGER_UI_PATH}}";
