 ...
 * href="https://github.com/swagger-api/swagger-ui/blob/master/docs/usage/configuration.md">configuration.md</a> to get
 * the idea what each parameter does.
 */
...
public class SwaggerUiConfigProperties {
    ...
    /**
     * If set, enables filtering. The top bar will show an edit box that could be used to filter the tagged operations
     * that are shown.
     */
