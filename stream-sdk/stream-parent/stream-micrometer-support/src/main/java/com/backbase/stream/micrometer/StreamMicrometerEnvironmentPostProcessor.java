 ...
 */
public class StreamMicrometerEnvironmentPostProcessor implements EnvironmentPostProcessor {

	protected static final String PROPERTY_SOURCE_KEY_NAME = StreamMicrometerEnvironmentPostProcessor.class.getName();
