...
public class LegalEntitySaga extends HelperProcessor implements StreamTaskExecutor<LegalEntityTask> {
    ...
    private Mono<List<BusinessFunctionGroup>> getBusinessFunctionGroupTemplates(LegalEntityTask streamTask,
        ...
        if (!isEmpty(jobProfileUser.getReferenceJobRoleNames())) {
            return accessGroupService.getFunctionGroupsForServiceAgreement(
                ...
                .map(functionGroups -> {
                    Map<String, com.backbase.accesscontrol.functiongroup.api.service.v1.model.FunctionGroupItem> idByFunctionGroupName = functionGroups
                        .stream()
    ...
    private Limit getLimits(ServiceAgreement serviceAgreement, Participant participant) {
