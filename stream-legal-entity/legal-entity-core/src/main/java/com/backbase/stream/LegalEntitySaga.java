...
public class LegalEntitySaga implements StreamTaskExecutor<LegalEntityTask> {
    ...
    /**
     * Delete Legal Entity by provided Legal Entity external ID. <i>This call doesn't cover arrangements and
     * transactions removal. Should be done before caling this method.</i> </br> Flow is the following:
     *
     * <ul>
