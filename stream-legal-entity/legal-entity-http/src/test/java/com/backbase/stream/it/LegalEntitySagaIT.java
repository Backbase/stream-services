...
class LegalEntitySagaIT {
                ...
                WireMock.aResponse()
                    ...
                    .withBody(
                        "[{\"additions\":{},\"id\":\"500002\",\"serviceAgreementId\":\"500001\",\"name\":\"Private"
                            + " - Read only\",\"description\":\"Private - Read"
                            ...
                            + " - Full access\",\"description\":\"Private - Full"
  ...
  /**
   * Intention of this test is to verify that custom header which passed to legal entity controller
   * is re-propagated to downstream call as well.
   */
  @Test
  void legalEntitySaga() {
    ...
    verify(
        WireMock.getRequestedFor(
                WireMock.urlEqualTo("/access-control/service-api/v2/legalentities/500000"))
