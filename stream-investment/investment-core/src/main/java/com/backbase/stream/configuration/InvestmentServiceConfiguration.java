...
@Configuration
@ConditionalOnProperty(name = "backbase.bootstrap.ingestions.investment.enabled", havingValue = "true")
public class InvestmentServiceConfiguration {
    ...
    @Bean
    @Primary
    public InvestmentAssetUniverseSaga investmentAssetUniverseSaga(
