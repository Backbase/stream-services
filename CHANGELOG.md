...
created: `BatchProductIngestionMode.upsert`and `BatchProductIngestionMode.replace` (equivalent of previous `UPDATE` and `REPLACE`, respectively), 
but new ones can be composed of any combination of "sub modes".
