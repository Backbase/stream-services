...
class PaymentOrderIntegrationServiceImplTest {
    ...
    @Mock private PaymentOrderIntegrationApi paymentOrderIntegrationApi;
    ...
    void setUp() {
        paymentOrderIntegrationService =
                new PaymentOrderIntegrationServiceImpl(
                        paymentOrderIntegrationApi, paymentOrderMapper);
    }
    ...
    void pullPaymentOrderTest() {
        ...
        StepVerifier.create(
                        paymentOrderIntegrationService.pullPaymentOrder(
                                paymentOrderIngestPullRequest))
