...
class LegalEntityIntegrationServiceImplTest {
    ...
    @Mock private LegalEntityIntegrationApi legalEntityIntegrationApi;

    @Mock private LegalEntityMapper legalEntityMapper;
    ...
    void callLE() throws UnsupportedOperationException {
        ...
        StepVerifier.create(
                        legalEntityIntegrationService.pullLegalEntity(new LegalEntityPullRequest()))
                .expectNext(res1)
                .expectComplete()
                .verify();
    }
