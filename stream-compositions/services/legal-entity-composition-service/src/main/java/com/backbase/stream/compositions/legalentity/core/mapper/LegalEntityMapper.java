...
/**
 * This is a mapper for LegalEntity objects used in: - stream-models/legal-entity-model - legal-entity-composition-api -
 * legal-entity-integration-api - legal-entity-evens
 *
...
public interface LegalEntityMapper {
     ...
     */
    com.backbase.stream.legalentity.model.LegalEntity mapIntegrationToStream(LegalEntity legalEntity);
