...
- `java -jar target/stream-compositions-service-1.0.0-SNAPSHOT.jar`
...
The official stream-compositions-service support room is [#s-stream-compositions-service](https://todo).
