...
public class PortfolioIntegrationService {
     ...
     */
    public Mono<AggregatePortfolio> createAggregatePortfolio(
        ...
        return aggregatePortfolioManagementApi
                ...
                .onErrorResume(
                        WebClientResponseException.class,
                        throwable -> Mono.just(aggregatePortfolio));
    }
    ...
    public Mono<PositionBundle> upsertPosition(PositionBundle positionBundle) {
        ...
        return positionManagementApi
                ...
                .thenMany(
                        upsertTransactions(
                                positionBundle.getTransactions(), portfolioId, positionId))
                .then(Mono.just(positionBundle))
                .doOnError(
                        WebClientResponseException.class,
                        ReactiveStreamHandler::handleWebClientResponseException)
                .onErrorResume(
                        WebClientResponseException.class, throwable -> Mono.just(positionBundle));
    }
                ...
                .switchIfEmpty(
                        Mono.defer(
                                () ->
                                        positionManagementApi
                                                .postPositions(
                                                        portfolioMapper.mapPostPosition(position))
                                                .map(o -> position)))
                .map(at -> position)
                .doOnError(
                        WebClientResponseException.class,
        ...
        return portfolioManagementApi
                ...
                .switchIfEmpty(
                        Mono.defer(
                                () ->
                                        portfolioManagementApi
                                                .postPortfolios(
                                                        portfolioMapper.mapPortfolio(portfolio))
                                                // add update handle
                                                .onErrorResume(
                                                        WebClientResponseException.Conflict.class,
                ...
                .onErrorResume(
                        ...
                        ReactiveStreamHandler.error(
                                portfolioBundle, "Failed to create Portfolio gang"));
    }
    ...
    public Mono<List<com.backbase.stream.portfolio.model.TransactionCategory>>
            upsertTransactionCategories(
                    List<com.backbase.stream.portfolio.model.TransactionCategory>
                                                ...
                                                () -> {
                                                    ...
                                                    return transactionManagementApi
                                                            .postPortfolioTransactions(
                                                                    portfolioId,
                                                                    createPortfolioTransactionsPostRequest(
                                                                            transaction,
                                                                            positionId));
                                                })
                                        .doOnError(
        ...
        return new PortfolioTransactionsPostRequest()
                .addTransactionsItem(
                        new PortfolioTransactionsPostItem()
                                ...
                                .addTransactionsItem(
                                        portfolioMapper.mapTransactionPostItem(transaction)));
    }
                                ...
                                portfolioManagementApi
                                        .putPortfolioAllocations(
                                                ...
                                                new PortfolioAllocationsPutRequest()
                                                        .allocations(
                                                                portfolioMapper.mapAllocations(a)))
                                        .doOnError(
                                                WebClientResponseException.class,
                                                ReactiveStreamHandler
                                                        ::handleWebClientResponseException)
                        ...
                        cumulativePerformances ->
                                portfolioCumulativePerformanceManagementApi
                                        ...
                                        .onErrorResume(
                                                ...
                                                ReactiveStreamHandler.error(
                                                        cumulativePerformances,
                                                        "Failed to create Portfolio Cumulative"
                                                                + " Performances")));
    }
                ...
                .flatMap(
                        existBenchmarks -> {
                            ...
                            return existBenchmarks.stream()
                                    ...
                                    .map(
                                            existBenchmark ->
                                                    portfolioBenchmarksManagementApi
                                                            .putPortfolioBenchmark(
                                                                    existBenchmark.getId(),
                                                                    portfolioMapper.mapBenchmark(
                                                                            name)))
                                    .or(
                                            () ->
                                                    Optional.of(
                                    ...
                                    .onErrorResume(
                                            WebClientResponseException.class,
                                            ReactiveStreamHandler.error(
                                                    name, "Failed to create Portfolio Benchmark"));
                        });
    }
