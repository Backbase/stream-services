...
class PortfolioIntegrationServiceTest {
  ...
  @Mock private PortfolioManagementApi portfolioManagementApi;

  @Mock private PositionManagementApi positionManagementApi;

  @Mock private TransactionManagementApi transactionManagementApi;

  @Mock private TransactionCategoryManagementApi transactionCategoryManagementApi;

  @Mock private SubPortfolioManagementApi subPortfolioManagementApi;

  @Mock private PortfolioPositionsHierarchyManagementApi portfolioPositionsHierarchyManagementApi;

  @Mock
  private PortfolioCumulativePerformanceManagementApi portfolioCumulativePerformanceManagementApi;

  @Mock private PortfolioBenchmarksManagementApi portfolioBenchmarksManagementApi;

  @Mock private PortfolioValuationManagementApi portfolioValuationManagementApi;

  @Mock private AggregatePortfolioManagementApi aggregatePortfolioManagementApi;

  @InjectMocks private PortfolioIntegrationService portfolioIntegrationService;
  ...
  void shouldCreateAgreateAggregatePortfolio() {
    ...
    when(aggregatePortfolioManagementApi.postAggregatePortfolios(
            any(AggregatePortfoliosPostRequest.class)))
    ...
    verify(aggregatePortfolioManagementApi, times(0))
        .putAggregatePortfolio(anyString(), any(AggregatePortfoliosPutRequest.class));
  }
  ...
  void shouldUpdateAgreateAggregatePortfolio() {
        ...
        .thenReturn(
            Mono.error(
                WebClientResponseException.create(
                    ...
                    new byte[] {},
                    null)));
    when(aggregatePortfolioManagementApi.putAggregatePortfolio(
            anyString(), any(AggregatePortfoliosPutRequest.class)))
        .thenReturn(Mono.empty());
    ...
    verify(aggregatePortfolioManagementApi)
        .postAggregatePortfolios(new AggregatePortfoliosPostRequest().id(arrangementId));
    verify(aggregatePortfolioManagementApi)
        .putAggregatePortfolio(arrangementId, portfolioMapper.mapPutAggregate(aggregatePortfolios));
  }
  ...
  void shouldCreatePosition_PositionBundle() {
    ...
    PositionBundle positionBundle =
        new PositionBundle()
            ...
            .transactions(
                List.of(new PositionTransaction().transactionId(transactionId).exchange(exchange)));
    ...
    when(positionManagementApi.postPositions(any(PositionsPostRequest.class)))
        .thenReturn(Mono.empty());
    when(transactionCategoryManagementApi.postTransactionCategory(
            any(TransactionCategoryPostRequest.class)))
        .thenReturn(Mono.empty());
    when(transactionManagementApi.putPositionTransactionById(
            anyString(), anyString(), any(PositionTransactionPutRequest.class)))
        .thenReturn(
            Mono.error(
                WebClientResponseException.create(
                    ...
                    new byte[] {},
                    null)));
    when(transactionManagementApi.postPortfolioTransactions(
            anyString(), any(PortfolioTransactionsPostRequest.class)))
        .thenReturn(Mono.empty());
    ...
    verify(positionManagementApi)
        .postPositions(
            new PositionsPostRequest()
                ...
                .transactions(
                    List.of(
                        new PortfolioTransactionsPostItem()
                            ...
                            .transactions(
                                List.of(
                                    new PortfolioPositionTransactionsPostItem()
  ...
  void shouldCreatePosition_Position() throws Exception {
    ...
    verify(positionManagementApi)
        .postPositions(
            new PositionsPostRequest()
                ...
                .instrumentId(instrumentId)
                .absolutePerformance(
                    new Money().amount(BigDecimal.valueOf(44.12)).currencyCode(EUR_CURRENCY_CODE))
                .relativePerformance(BigDecimal.valueOf(1.2))
                .purchasePrice(
                    new Money().amount(BigDecimal.valueOf(124.18)).currencyCode(EUR_CURRENCY_CODE))
                .unrealizedPLPct(BigDecimal.valueOf(4.14))
                .unrealizedPL(
                    new Money().amount(BigDecimal.valueOf(34.12)).currencyCode(EUR_CURRENCY_CODE))
                .todayPLPct(BigDecimal.valueOf(1.14))
                .todayPL(
                    new Money().amount(BigDecimal.valueOf(14.12)).currencyCode(EUR_CURRENCY_CODE))
                .accruedInterest(
                    new Money().amount(BigDecimal.valueOf(12.45)).currencyCode(EUR_CURRENCY_CODE))
                .quantity(BigDecimal.valueOf(187))
                .valuation(
                    new Money().amount(BigDecimal.valueOf(132.11)).currencyCode(EUR_CURRENCY_CODE))
                .costPrice(
                    new Money().amount(BigDecimal.valueOf(145.11)).currencyCode(EUR_CURRENCY_CODE))
                .costExchangeRate(
                    new Money().amount(BigDecimal.valueOf(1.23)).currencyCode(EUR_CURRENCY_CODE))
    ...
    verify(positionManagementApi, times(0))
        .putPosition(anyString(), any(PositionsPutRequest.class));
  }
  ...
  void shouldUpdatePosition_Position() throws Exception {
    ...
    Mono<PositionsGetItem> positionGetResponse =
        Mono.just(new PositionsGetItem().externalId(positionId));

    when(positionManagementApi.getPositionById(positionId)).thenReturn(positionGetResponse);
    when(positionManagementApi.putPosition(anyString(), any(PositionsPutRequest.class)))
        .thenReturn(Mono.empty());

    portfolioIntegrationService.upsertPosition(position0).block();

    verify(positionManagementApi, times(1)).getPositionById(positionId);
    verify(positionManagementApi, times(1))
        .putPosition(
            positionId,
            new PositionsPutRequest()
                .absolutePerformance(
                    new Money().amount(BigDecimal.valueOf(44.12)).currencyCode(EUR_CURRENCY_CODE))
                .relativePerformance(BigDecimal.valueOf(1.2))
                .purchasePrice(
  ...
  void shouldUpdatePositionTransactions() throws Exception {
    ...
    List<TransactionBundle> transactionBundles =
    ...
    List<PositionTransactionBundle> positionTransactionBundles =
        transactionBundle0.getTransactions();
    ...
    portfolioIntegrationService
        .upsertTransactions(transactions, portfolioCode, positionId)
        .blockLast();

    verify(transactionManagementApi, times(1))
    ...
    verify(transactionManagementApi, times(0))
        .postPortfolioTransactions(
            portfolioCode,
            new PortfolioTransactionsPostRequest()
                .addTransactionsItem(
                    new PortfolioTransactionsPostItem()
                        .positionId(positionId)
                        .addTransactionsItem(
                            portfolioMapper.mapTransactionPostItem(positionTransaction0))));
  }
  ...
  void shouldCreatePortfolio_PortfolioBundle() {
    ...
    PortfolioBundle portfolioBundle =
        new PortfolioBundle()
            ...
            .addHierarchiesItem(
                new PortfolioPositionsHierarchy()
                    .itemType(PortfolioPositionsHierarchy.ItemTypeEnum.ASSET_CLASS))
            .addCumulativePerformancesItem(
                new PortfolioCumulativePerformances().valuePct(BigDecimal.TEN))
            .benchmark(new PortfolioBenchmark().name(benchmarkName))
            .addValuationsItem(new PortfolioValuation().valuePct(BigDecimal.ONE));

    when(portfolioManagementApi.postPortfolios(any(PortfoliosPostRequest.class)))
        .thenReturn(Mono.empty());
    when(subPortfolioManagementApi.postSubPortfolios(
            anyString(), any(SubPortfoliosPostRequest.class)))
        .thenReturn(Mono.empty());
    when(portfolioManagementApi.putPortfolioAllocations(
            anyString(), any(PortfolioAllocationsPutRequest.class)))
        .thenReturn(Mono.empty());
    when(portfolioPositionsHierarchyManagementApi.putPortfolioPositionsHierarchy(
            anyString(), any(PortfolioPositionsHierarchyPutRequest.class)))
        .thenReturn(Mono.empty());
    when(portfolioCumulativePerformanceManagementApi.putPortfolioCumulativePerformance(
            anyString(), any(PortfolioCumulativePerformancesPutRequest.class)))
        .thenReturn(Mono.empty());
    when(portfolioBenchmarksManagementApi.postPortfolioBenchmark(
            any(PortfolioBenchmarkPostRequest.class)))
        .thenReturn(Mono.empty());
    when(portfolioValuationManagementApi.putPortfolioValuations(
            anyString(), any(PortfolioValuationsPutRequest.class)))
        .thenReturn(Mono.empty());
    when(subPortfolioManagementApi.getSubPortfolio(anyString(), anyString()))
        .thenReturn(Mono.empty());
    ...
    verify(portfolioManagementApi)
        .postPortfolios(new PortfoliosPostRequest().code(portfolioId).iban(iban));
    verify(subPortfolioManagementApi)
        .postSubPortfolios(portfolioId, new SubPortfoliosPostRequest().code(subPortfolioCode));
    verify(portfolioManagementApi)
        .putPortfolioAllocations(
            portfolioId,
            new PortfolioAllocationsPutRequest()
                .addAllocationsItem(
                    new PortfolioAllocationsParentItem()
                        .classifierType(AllocationClassifierType.ASSET_CLASS)));
    verify(portfolioPositionsHierarchyManagementApi)
        .putPortfolioPositionsHierarchy(
            portfolioId,
            new PortfolioPositionsHierarchyPutRequest()
                .addItemsItem(
                    new PortfolioPositionsHierarchyItem()
                        .itemType(PortfolioPositionsHierarchyItem.ItemTypeEnum.ASSET_CLASS)));
    verify(portfolioCumulativePerformanceManagementApi)
        .putPortfolioCumulativePerformance(
            portfolioId,
            new PortfolioCumulativePerformancesPutRequest()
                .addCumulativePerformanceItem(
                    new PortfolioCumulativePerformancesItem().valuePct(BigDecimal.TEN)));
    verify(portfolioBenchmarksManagementApi)
        .postPortfolioBenchmark(
            new PortfolioBenchmarkPostRequest().id(portfolioId).name(benchmarkName));
    verify(portfolioValuationManagementApi)
  ...
  void shouldCreatePortfolio_Portfolio() throws Exception {
    ...
    verify(portfolioManagementApi, times(0))
        .putPortfolio(anyString(), any(PortfoliosPutRequest.class));
  }
  ...
  void shouldUpdatePortfolio_Portfolio() throws Exception {
    ...
    when(portfolioManagementApi.getPortfolio(anyString()))
        .thenReturn(
            Mono.just(
                new PortfoliosGetResponse()
                    .addPortfoliosItem(new PortfoliosGetItem().code(portfolioCode))
                    .getPortfolios()
                    .get(0)));
    ...
    verify(portfolioManagementApi)
        .putPortfolio(portfolioCode, portfolioMapper.mapPutPortfolio(portfolio0));
  ...
  void shouldCreateSubPortfolio() throws Exception {
    ...
    verify(subPortfolioManagementApi)
        .postSubPortfolios(portfolioCode0, portfolioMapper.mapSubPortfolio(subPortfolio0));
    verify(subPortfolioManagementApi)
        .postSubPortfolios(portfolioCode0, portfolioMapper.mapSubPortfolio(subPortfolio1));

    verify(subPortfolioManagementApi, times(0))
        .putSubPortfolio(anyString(), anyString(), any(SubPortfoliosPutRequest.class));
  }
  ...
  void shouldUpdateSubPortfolio() throws Exception {
    ...
    when(subPortfolioManagementApi.putSubPortfolio(
            anyString(), anyString(), any(SubPortfoliosPutRequest.class)))
        .thenReturn(Mono.empty());
    ...
    verify(subPortfolioManagementApi)
        .putSubPortfolio(
            portfolioCode0, subPortfolioCode0, portfolioMapper.mapPutSubPortfolio(subPortfolio0));

    verify(subPortfolioManagementApi, times(0))
        .postSubPortfolios(anyString(), any(SubPortfoliosPostRequest.class));
  }
  ...
  void shouldCreateTransactionCategories() throws Exception {
    ...
    verify(transactionCategoryManagementApi, times(0))
        .putTransactionCategory(anyString(), any(TransactionCategoryPutRequest.class));
  }
  ...
  void shouldUpdateTransactionCategories() throws Exception {
    ...
    when(transactionCategoryManagementApi.getTransactionCategories())
        .thenReturn(
            Flux.fromIterable(
                List.of(
                    new com.backbase.portfolio.api.service.integration.v1.model
                            .TransactionCategory()
                        .key(key0),
                    new com.backbase.portfolio.api.service.integration.v1.model
                            .TransactionCategory()
                        .key(key1))));
    when(transactionCategoryManagementApi.putTransactionCategory(
            anyString(), any(TransactionCategoryPutRequest.class)))
        .thenReturn(Mono.empty());
    ...
    verify(transactionCategoryManagementApi)
        .putTransactionCategory(
            key0, portfolioMapper.mapPutTransactionCategory(transactionCategory0));
    verify(transactionCategoryManagementApi)
        .putTransactionCategory(
            key1, portfolioMapper.mapPutTransactionCategory(transactionCategory1));
  ...
  void shouldUpdateValuations() throws Exception {
    ...
    verify(portfolioValuationManagementApi)
        .putPortfolioValuations(
            portfolioCode0,
            new PortfolioValuationsPutRequest()
                .valuations(portfolioMapper.mapValuations(valuations0)));
  }
}
