...
class PortfolioIntegrationServiceTest {
    ...
    void shouldCreatePosition_PositionBundle() {
        ...
        PositionBundle positionBundle = new PositionBundle().portfolioId(portfolioId)
                ...
                .addTransactionCategoriesItem(new TransactionCategory().key(transactionCategoryKey)
                        .alias(categoryAlias))
        ...
        when(transactionManagementApi.postPortfolioTransactions(anyString(),
                                                                any(PortfolioTransactionsPostRequest.class)))
                                                                        .thenReturn(Mono.empty());
        ...
        verify(transactionCategoryManagementApi)
                .postTransactionCategory(new TransactionCategoryPostRequest().key(transactionCategoryKey)
                        .alias(categoryAlias));
        verify(transactionManagementApi)
                .postPortfolioTransactions(portfolioId,
                                           new PortfolioTransactionsPostRequest().transactions(List
                                                   .of(new PortfolioTransactionsPostItem().positionId(positionId)
                                                           .transactions(List
                                                                   .of(new PortfolioPositionTransactionsPostItem()
                                                                           .exchange(exchange))))));
    }
    ...
    void shouldCreatePortfolio() {
        ...
        when(portfolioValuationManagementApi.putPortfolioValuations(anyString(),
                                                                    any(PortfolioValuationsPutRequest.class)))
                                                                            .thenReturn(Mono.empty());
        ...
        verify(portfolioManagementApi)
                .putPortfolioAllocations(portfolioId,
        ...
        verify(portfolioPositionsHierarchyManagementApi)
                .putPortfolioPositionsHierarchy(portfolioId,
                                                new PortfolioPositionsHierarchyPutRequest()
                                                        .addItemsItem(new PortfolioPositionsHierarchyItem()
                                                                .itemType(PortfolioPositionsHierarchyItem.ItemTypeEnum.ASSET_CLASS)));
        verify(portfolioCumulativePerformanceManagementApi)
                .putPortfolioCumulativePerformance(portfolioId,
                                                   new PortfolioCumulativePerformancesPutRequest()
                                                           .addCumulativePerformanceItem(new PortfolioCumulativePerformancesItem()
        ...
        verify(portfolioValuationManagementApi)
                .putPortfolioValuations(portfolioId,
                                        new PortfolioValuationsPutRequest()
                                                .addValuationsItem(new PortfolioValuationsItem()
                                                        .valuePct(BigDecimal.ONE)));
