...
class PortfolioIntegrationServiceTest {
    ...
    void shouldUpdateAgreateAggregatePortfolio() {
        ...
        verify(aggregatePortfolioManagementApi)
                .postAggregatePortfolios(new AggregatePortfoliosPostRequest().id(arrangementId));
        verify(aggregatePortfolioManagementApi)
                .putAggregatePortfolio(
                        arrangementId, portfolioMapper.mapPutAggregate(aggregatePortfolios));
    }
    ...
    void shouldCreatePosition_PositionBundle() {
        ...
        verify(transactionCategoryManagementApi)
                .postTransactionCategory(
                        new TransactionCategoryPostRequest()
                                .key(transactionCategoryKey)
                                .alias(categoryAlias));
        ...
        verify(positionManagementApi)
                .postPositions(
                        new PositionsPostRequest()
                                ...
                                .absolutePerformance(
                                        new Money()
                                                .amount(BigDecimal.valueOf(44.12))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .relativePerformance(BigDecimal.valueOf(1.2))
                                .purchasePrice(
                                        new Money()
                                                .amount(BigDecimal.valueOf(124.18))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .unrealizedPLPct(BigDecimal.valueOf(4.14))
                                .unrealizedPL(
                                        new Money()
                                                .amount(BigDecimal.valueOf(34.12))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .todayPLPct(BigDecimal.valueOf(1.14))
                                .todayPL(
                                        new Money()
                                                .amount(BigDecimal.valueOf(14.12))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .accruedInterest(
                                        new Money()
                                                .amount(BigDecimal.valueOf(12.45))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .quantity(BigDecimal.valueOf(187))
                                .valuation(
                                        new Money()
                                                .amount(BigDecimal.valueOf(132.11))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .costPrice(
                                        new Money()
                                                .amount(BigDecimal.valueOf(145.11))
                                                .currencyCode(EUR_CURRENCY_CODE))
                                .costExchangeRate(
                                        new Money()
                                                .amount(BigDecimal.valueOf(1.23))
                                                .currencyCode(EUR_CURRENCY_CODE))
                        ...
                        new PortfolioTransactionsPostRequest()
                                .addTransactionsItem(
                                        new PortfolioTransactionsPostItem()
                                                .positionId(positionId)
                                                .addTransactionsItem(
                                                        portfolioMapper.mapTransactionPostItem(
                                                                positionTransaction0))));
    }
    ...
    void shouldCreatePortfolio_PortfolioBundle() {
                ...
                new PortfolioBundle()
                        ...
                        .addHierarchiesItem(
                                new PortfolioPositionsHierarchy()
                                        .itemType(
                                                PortfolioPositionsHierarchy.ItemTypeEnum
                                                        .ASSET_CLASS))
        ...
        verify(subPortfolioManagementApi)
                .postSubPortfolios(
                        portfolioId, new SubPortfoliosPostRequest().code(subPortfolioCode));
        verify(portfolioManagementApi)
                        ...
                        new PortfolioAllocationsPutRequest()
                                .addAllocationsItem(
                                        new PortfolioAllocationsParentItem()
                                                .classifierType(
                                                        AllocationClassifierType.ASSET_CLASS)));
                        ...
                        new PortfolioPositionsHierarchyPutRequest()
                                .addItemsItem(
                                        new PortfolioPositionsHierarchyItem()
                                                .itemType(
                                                        PortfolioPositionsHierarchyItem.ItemTypeEnum
                                                                .ASSET_CLASS)));
                ...
                .putPortfolioCumulativePerformance(
                        ...
                        new PortfolioCumulativePerformancesPutRequest()
                                .addCumulativePerformanceItem(
                                        new PortfolioCumulativePerformancesItem()
                                                .valuePct(BigDecimal.TEN)));
        ...
        verify(portfolioValuationManagementApi)
                .putPortfolioValuations(
                        ...
                        new PortfolioValuationsPutRequest()
                                .addValuationsItem(
                                        new PortfolioValuationsItem().valuePct(BigDecimal.ONE)));
    }
    ...
    void shouldUpdateSubPortfolio() throws Exception {
        ...
        portfolioIntegrationService
                .upsertSubPortfolios(List.of(subPortfolio0), portfolioCode0)
                .block();
    ...
    void shouldCreateTransactionCategories() throws Exception {
        ...
        verify(transactionCategoryManagementApi)
                .postTransactionCategory(
                        portfolioMapper.mapTransactionCategory(transactionCategory0));
        verify(transactionCategoryManagementApi)
                .postTransactionCategory(
                        portfolioMapper.mapTransactionCategory(transactionCategory1));
