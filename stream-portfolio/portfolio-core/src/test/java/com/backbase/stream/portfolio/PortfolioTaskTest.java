...
class PortfolioTaskTest {
    ...
    void shouldNotBeEqual() {
        PortfolioTask portfolioTask1 =
            new PortfolioTask(new WealthBundle().addRegionsItem(RegionTestUtil.createRegionBundleUs()));

        PortfolioTask portfolioTask2 =
            new PortfolioTask(new WealthBundle().addRegionsItem(RegionTestUtil.createRegionBundleEu()));
