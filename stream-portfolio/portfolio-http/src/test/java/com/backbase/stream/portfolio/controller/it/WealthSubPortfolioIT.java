...
class WealthSubPortfolioIT {
    ...
    private void setupWireMock() {
        ...
        WireMock.stubFor(WireMock.get("/portfolio/integration-api/v1/portfolios/1234/sub-portfolios/1427804")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("{\"code\":\"1234\", \"name\": \"testName\", \"valuation\": {\"amount\": 34.5, "
                                + "\"currencyCode\": \"EUR\"}, \"performance\": 54.6, \"percentOfParent\": 32.5}")));

        WireMock.stubFor(WireMock.get("/portfolio/integration-api/v1/portfolios/1234/sub-portfolios/1427805")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("{\"code\":\"1234\", \"name\": \"testName\", \"valuation\": {\"amount\": 34.5, "
                                + "\"currencyCode\": \"EUR\"}, \"performance\": 54.6, \"percentOfParent\": 32.5}")));

        WireMock.stubFor(WireMock.put("/portfolio/integration-api/v1/portfolios/1234/sub-portfolios/1427804")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.put("/portfolio/integration-api/v1/portfolios/1234/sub-portfolios/1427805")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
    }
