...
class WealthAssetsIT {
    ...
    void shouldIngestRegionBundles() throws Exception {
        ...
        WireMock.verify(WireMock
                .getRequestedFor(
                        WireMock.urlEqualTo("/portfolio/integration-api/v1/asset-classes?from=0&size=2147483647"))
    ...
    private void setupWireMock() {
        ...
        WireMock.stubFor(WireMock.post("/portfolio/integration-api/v1/asset-classes")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.post("/portfolio/integration-api/v1/asset-classes/OvBckZySky/sub-asset-classes")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.post("/portfolio/integration-api/v1/asset-classes/iWDEjAewOq/sub-asset-classes")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.post("/portfolio/integration-api/v1/asset-classes/KAmfp8dZWo/sub-asset-classes")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.post("/portfolio/integration-api/v1/asset-classes/L1mC78IIVj/sub-asset-classes")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
    }
