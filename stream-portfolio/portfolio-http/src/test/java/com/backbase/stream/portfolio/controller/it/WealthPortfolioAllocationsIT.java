...
class WealthPortfolioAllocationsIT {
    ...
    void shouldIngestPortfolioAllocations() throws Exception {
        ...
        WireMock.verify(
            WireMock.putRequestedFor(
                    WireMock.urlEqualTo("/portfolio/integration-api/v1/portfolios/1234/allocations"))
                .withHeader(X_TID_HEADER_NAME, WireMock.equalTo(X_TID_HEADER_VALUE)));

        WireMock.verify(
            WireMock.putRequestedFor(
                    WireMock.urlEqualTo("/portfolio/integration-api/v1/portfolios/5678/allocations"))
                .withHeader(X_TID_HEADER_NAME, WireMock.equalTo(X_TID_HEADER_VALUE)));
    ...
    private void setupWireMock() {
        ...
        WireMock.stubFor(
            WireMock.put("/portfolio/integration-api/v1/portfolios/1234/allocations")
                .willReturn(
                    WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
        ...
        WireMock.stubFor(
            WireMock.put("/portfolio/integration-api/v1/portfolios/5678/allocations")
                .willReturn(
                    WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
