...
class WealthPortfolioValuationsIT {
    ...
    private void setupWireMock() {
        ...
        WireMock.stubFor(WireMock.delete("/portfolio/integration-api/v1/portfolios/1234/valuations?granularity=DAILY")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.delete("/portfolio/integration-api/v1/portfolios/1234/valuations?granularity=WEEKLY")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.delete("/portfolio/integration-api/v1/portfolios/1234/valuations?granularity=MONTHLY")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
        ...
        WireMock.stubFor(WireMock.delete("/portfolio/integration-api/v1/portfolios/5678/valuations?granularity=DAILY")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.delete("/portfolio/integration-api/v1/portfolios/5678/valuations?granularity=WEEKLY")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));

        WireMock.stubFor(WireMock.delete("/portfolio/integration-api/v1/portfolios/5678/valuations?granularity=MONTHLY")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
        ...
        WireMock.stubFor(WireMock.put("/portfolio/integration-api/v1/portfolios/1234/valuations")
                .willReturn(WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("")));
    }
