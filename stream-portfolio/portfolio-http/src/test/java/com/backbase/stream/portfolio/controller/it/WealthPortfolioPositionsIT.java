...
class WealthPortfolioPositionsIT {
    ...
    void shouldIngestTransactionCategories() throws Exception {
        ...
        WireMock.verify(
            WireMock.getRequestedFor(
                    WireMock.urlEqualTo("/portfolio/integration-api/v1/positions/ID543894783"))
    ...
    private void setupWireMock() {
        ...
        WireMock.stubFor(
            WireMock.get("/portfolio/integration-api/v1/positions/ID543894783")
                .willReturn(
                    WireMock.aResponse()
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody(
                            "{\"externalId\": \"externalId\", \"instrumentId\":"
                                + " \"instrumentId\", \"portfolioCode\":"
                                + " \"portfolioCode\", \"subPortfolioCode\":"
                                + " \"subPortfolioCode\"}")));

        WireMock.stubFor(
            WireMock.put("/portfolio/integration-api/v1/positions/ID543894783")
