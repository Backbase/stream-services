...
class PortfolioIT {
  ...
  void shouldIngestPortfolios() throws Exception {
    ...
    verify(
        WireMock.getRequestedFor(
                WireMock.urlEqualTo("/portfolio/integration-api/v1/regions?from=0&size=2147483647"))
  ...
  private void setupWireMock() {
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/regions/EU/countries?from=0&size=2147483647")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("{\"countries\":[]}")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/regions/US/countries?from=0&size=2147483647")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("{\"countries\":[]}")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002010/sub-portfolios/999629")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002010/sub-portfolios/999629")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/997044")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/997044")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/992412")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/992412")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/992413")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/992413")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/997045")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002008/sub-portfolios/997045")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002007/sub-portfolios/994570")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002007/sub-portfolios/994570")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002007/sub-portfolios/994571")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002007/sub-portfolios/994571")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/960464/sub-portfolios/1427804")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/960464/sub-portfolios/1427804")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/960464/sub-portfolios/1427805")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/960464/sub-portfolios/1427805")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.get("/portfolio/integration-api/v1/portfolios/PS800002010/sub-portfolios/999628")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody(
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002010/sub-portfolios/999628")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.post("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_SARA/sub-portfolios")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.post("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_ROHIT/sub-portfolios")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_SARA/allocations")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_ROHIT/allocations")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_SARA/hierarchies")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_ROHIT/hierarchies")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/960464/cumulative-performances")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002007/cumulative-performances")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002008/cumulative-performances")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/PS800002010/cumulative-performances")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.put("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_ROHIT/valuations")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.post("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_ROHIT/transactions")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
    ...
    WireMock.stubFor(
        WireMock.post("/portfolio/integration-api/v1/portfolios/ARRANGEMENT_SARA/transactions")
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                    .withBody("")));
