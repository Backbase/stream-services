...
class WealthTransactionCategoriesIT {
    ...
    void shouldIngestTransactionCategories() throws Exception {
        ...
        // Then
        WireMock.verify(
                WireMock.getRequestedFor(WireMock.urlEqualTo("/portfolio/integration-api/v1/transaction-categories"))
                        .withHeader(X_TID_HEADER_NAME, WireMock.equalTo(X_TID_HEADER_VALUE)));

        WireMock.verify(
                WireMock.postRequestedFor(WireMock.urlEqualTo("/portfolio/integration-api/v1/transaction-categories"))
                        .withHeader(X_TID_HEADER_NAME, WireMock.equalTo(X_TID_HEADER_VALUE)));
