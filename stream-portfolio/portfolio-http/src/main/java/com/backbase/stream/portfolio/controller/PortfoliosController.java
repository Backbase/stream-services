...
public class PortfoliosController implements PortfoliosApi {
    ...
    @Override
    public Mono<ResponseEntity<Flux<WealthBundle>>> createPortfolios(
        Flux<WealthBundle> wealthBundle, ServerWebExchange exchange) {
        return Mono.just(ResponseEntity.ok(portfolioReactiveService.ingestWealthBundles(wealthBundle)));
    }

    @Override
    public Mono<ResponseEntity<Flux<RegionBundle>>> createPortfioliosRegionsBatch(
        Flux<RegionBundle> regionBundle, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(instrumentIngestionReactiveService.ingestRegionBundles(regionBundle)));
    }

    @Override
    public Mono<ResponseEntity<Flux<AllocationBundle>>> createAllocationsBatch(
        Flux<AllocationBundle> allocationBundle, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(
                portfolioIngestionReactiveService.ingestPortfolioAllocationBundles(allocationBundle)));
    }
    ...
    public Mono<ResponseEntity<Flux<AssetClassBundle>>> createPortfioliosAssetClassesBatch(
        ...
        return Mono.just(
            ResponseEntity.ok(instrumentIngestionReactiveService.ingestWealthAssets(assetClassBundle)));
    }

    @Override
    public Mono<ResponseEntity<Flux<Portfolio>>> createPortfioliosBatch(
        Flux<Portfolio> portfolio, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(portfolioIngestionReactiveService.ingestWealthPortfolios(portfolio)));
    }
    ...
    public Mono<ResponseEntity<Flux<SubPortfolioBundle>>> createSubPortfioliosBatch(
        ...
        return Mono.just(
            ResponseEntity.ok(
                portfolioIngestionReactiveService.ingestWealthSubPortfolios(subPortfolioBundle)));
    }

    @Override
    public Mono<ResponseEntity<Flux<InstrumentBundle>>> createInstrumentsBatch(
        Flux<InstrumentBundle> instrumentBundle, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(instrumentIngestionReactiveService.ingestInstruments(instrumentBundle)));
    }
    ...
    public Mono<ResponseEntity<Flux<TransactionCategory>>> createTransactionCategoriesBatch(
        ...
        return Mono.just(
            ResponseEntity.ok(
                portfolioIngestionReactiveService.ingestTransactionCategories(transactionCategory)));
    }

    @Override
    public Mono<ResponseEntity<Flux<ValuationsBundle>>> createValuationsBatch(
        Flux<ValuationsBundle> valuationsBundle, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(
                portfolioIngestionReactiveService.ingestValuationsBundles(valuationsBundle)));
    }

    @Override
    public Mono<ResponseEntity<Flux<HierarchyBundle>>> createHierarchiesBatch(
        Flux<HierarchyBundle> hierarchyBundles, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(
                portfolioIngestionReactiveService.ingestHierarchyBundles(hierarchyBundles)));
    }

    @Override
    public Mono<ResponseEntity<Flux<Position>>> createPositionsBatch(
        Flux<Position> position, ServerWebExchange exchange) {
        return Mono.just(
            ResponseEntity.ok(portfolioIngestionReactiveService.ingestPositions(position)));
    }
    ...
    public Mono<ResponseEntity<Flux<TransactionBundle>>> createTransactionsBatch(
        ...
        return Mono.just(
            ResponseEntity.ok(
                portfolioIngestionReactiveService.ingestTransactionBundles(transactionBundle)));
    }
}
