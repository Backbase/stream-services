...
public class PortfoliosController implements PortfoliosApi {
    ...
    public Mono<ResponseEntity<Flux<WealthBundle>>> createPortfolios(
        ...
        return Mono.just(
                ResponseEntity.ok(portfolioReactiveService.ingestWealthBundles(wealthBundle)));
    }
    ...
    public Mono<ResponseEntity<Flux<RegionBundle>>> createPortfioliosRegionsBatch(
        ...
        return Mono.just(
                ResponseEntity.ok(
                        instrumentIngestionReactiveService.ingestRegionBundles(regionBundle)));
    }
    ...
    public Mono<ResponseEntity<Flux<AssetClassBundle>>> createPortfioliosAssetClassesBatch(
        ...
        return Mono.just(
                ResponseEntity.ok(
                        instrumentIngestionReactiveService.ingestWealthAssets(assetClassBundle)));
    }
    ...
    public Mono<ResponseEntity<Flux<Portfolio>>> createPortfioliosBatch(
        ...
        return Mono.just(
                ResponseEntity.ok(
                        portfolioIngestionReactiveService.ingestWealthPortfolios(portfolio)));
    }
    ...
    public Mono<ResponseEntity<Flux<InstrumentBundle>>> createInstrumentsBatch(
        ...
        return Mono.just(
                ResponseEntity.ok(
                        instrumentIngestionReactiveService.ingestInstruments(instrumentBundle)));
    }
