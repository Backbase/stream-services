...
public class ApprovalsIntegrationService {
    ...
    public Mono<ApprovalType> createApprovalType(ApprovalType approvalType) {
        return approvalTypesApi
                .postApprovalType(approvalMapper.mapApprovalType(approvalType))
                ...
                .onErrorResume(
                        ...
                        exception ->
                                Mono.error(
                                        new ApprovalTypeException(
                                                approvalType,
                                                "Failed to create Approval Type Level",
                                                exception)))
                .onErrorStop();
    }
    ...
    public Mono<Policy> createPolicy(Policy policy) {
        return policiesApi
                .postPolicy(policyMapper.mapPolicy(policy))
                ...
                .onErrorResume(
                        ...
                        exception ->
                                Mono.error(
                                        new PolicyException(
                                                policy, "Failed to create Policy", exception)))
                .onErrorStop();
    }

    public Mono<PolicyAssignment> assignPolicies(PolicyAssignment policyAssignment) {
        return policyAssignmentsApi
                .postCreatesBulkPolicyAssignments(
                        policyMapper.mapPolicyAssignments(policyAssignment))
                ...
                .onErrorResume(
                        ...
                        exception ->
                                Mono.error(
                                        new PolicyAssignmentException(
                                                policyAssignment,
                                                "Failed to assign approval type",
                                                exception)))
                .onErrorStop();
    }
