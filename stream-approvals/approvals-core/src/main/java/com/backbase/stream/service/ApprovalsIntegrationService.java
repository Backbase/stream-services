                ...
                exception ->
                    Mono.error(
                        new ApprovalTypeException(
                            approvalType, "Failed to create Approval Type Level", exception)))
            .onErrorStop();
    }
                ...
                exception ->
                    Mono.error(
                        new PolicyAssignmentException(
                            policyAssignment, "Failed to assign policy", exception)))
            .onErrorStop();
    }
        ...
        return approvalTypeAssignmentsApi
            ...
            .onErrorResume(
                ...
                exception ->
                    Mono.error(
                        new PolicyAssignmentException(
                            policyAssignment, "Failed to assign approval type", exception)))
            .onErrorStop();
    }
