...
/**
 * Approval Saga. This Service creates Approvals and their supporting objects from a {@link Approval} aggregate object.
 * For each Approval object it will either create a new one. Next it will assign all defined policies
 */
@Slf4j
