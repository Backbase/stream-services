...
import com.backbase.dbs.paymentorder.api.service.v2.model.Currency;
import com.backbase.dbs.paymentorder.api.service.v2.model.GetPaymentOrderResponse;
import com.backbase.dbs.paymentorder.api.service.v2.model.Identification;
import com.backbase.dbs.paymentorder.api.service.v2.model.InstructionPriority;
import com.backbase.dbs.paymentorder.api.service.v2.model.InvolvedPartyRole;
import com.backbase.dbs.paymentorder.api.service.v2.model.PaymentMode;
import com.backbase.dbs.paymentorder.api.service.v2.model.PaymentOrderPostRequest;
import com.backbase.dbs.paymentorder.api.service.v2.model.PaymentOrderPutRequest;
import com.backbase.dbs.paymentorder.api.service.v2.model.SimpleInvolvedParty;
import com.backbase.dbs.paymentorder.api.service.v2.model.SimpleOriginatorAccount;
import com.backbase.dbs.paymentorder.api.service.v2.model.SimpleSchedule;
import com.backbase.dbs.paymentorder.api.service.v2.model.SimpleTransaction;
...
public abstract class PaymentOrderBaseTest {
    ...
    protected final PaymentOrderTypeMapper paymentOrderTypeMapper =
        Mappers.getMapper(PaymentOrderTypeMapper.class);

    protected final List<GetPaymentOrderResponse> getPaymentOrderResponse =
        buildGetPaymentOrderResponse();
    protected final List<PaymentOrderPostRequest> paymentOrderPostRequest =
        paymentOrderTypeMapper.mapPaymentOrderPostRequest(getPaymentOrderResponse);

    protected static WebClientResponseException buildWebClientResponseException(
    ...
    List<GetPaymentOrderResponse> buildGetPaymentOrderResponse() {
        ...
        for (int idx = 1; idx <= 2; idx++) {
            SimpleInvolvedParty involvedParty =
                new SimpleInvolvedParty()
                    .name("name_" + idx)
                    .recipientId("recipientId_" + idx)
                    .role(InvolvedPartyRole.CREDITOR);

            SimpleOriginatorAccount originatorAccount =
                new SimpleOriginatorAccount()
            ...
            GetPaymentOrderResponse getPaymentOrderResponse =
                new GetPaymentOrderResponse()
                    .id("id_" + idx)
                    ...
                    .transferTransactionInformation(
                        new SimpleTransaction().transferFee(new Currency().amount(String.valueOf(idx))))
