...
public class PaymentOrderTypeMapperTest extends PaymentOrderBaseTest {
    ...
    public void map_PaymentOrderPostRequest_To_PaymentOrderPutRequest() {
        ...
        Assertions.assertEquals(source.getSchedule().getNextExecutionDate(), target.getNextExecutionDate());
    ...
    public void map_GetPaymentOrderResponse_To_PaymentOrderPostRequest() {
        ...
        getPaymentOrderResponse.forEach(source -> {
            ...
            Assertions.assertEquals(source.getOriginator().getName(), target.getOriginator().getName());
            ...
            Assertions.assertEquals(source.getTransferTransactionInformation().getTransferFee(), target.getTransferTransactionInformation().getTransferFee());
            ...
            Assertions.assertEquals(source.getOriginatorAccountCurrency(), target.getOriginatorAccountCurrency());
