...
public interface LoanMapper {
  ...
  @Mapping(
      target = "debtAttributes.calculationPeriodStartDateTime",
      source = "calculationPeriodStartDateTime")
  @Mapping(
      target = "debtAttributes.calculationPeriodEndDateTime",
      source = "calculationPeriodEndDateTime")
  ...
  @Mapping(
      target = "interestAttributes.interestPaymentFrequency",
      source = "interestPaymentFrequency")
  @Mapping(
      target = "interestAttributes.totalAnnualCostPercentage",
      source = "totalAnnualCostPercentage")
  @Mapping(target = "overdueAttributes.inArrearsAmount", source = "amountInArrear")
  @Mapping(
      target = "overdueAttributes.inArrearsDateTime",
      expression = "java( toOffsetDateTime(loan.getOverdueSince()) )")
  ...
  @Mapping(
      target = "overdueAttributes.overdueEscrowPaymentAmount",
      source = "overdueEscrowPaymentAmount")
  @Mapping(
      target = "overdueAttributes.overduePrincipalPaymentAmount",
      source = "overduePrincipalPaymentAmount")
  @Mapping(
      target = "overdueAttributes.overdueTaxesOnInterestAmount",
      source = "overdueTaxesOnInterestAmount")
  @Mapping(
      target = "overdueAttributes.actualLatePaymentCommissionAmount",
      source = "actualLatePaymentCommissionAmount")
  @Mapping(
      target = "overdueAttributes.contractLatePaymentCommissionAmount",
      source = "contractLatePaymentCommissionAmount")
  @Mapping(
      target = "overdueAttributes.latePaymentCommissionTaxesAmount",
      source = "latePaymentCommissionTaxesAmount")
  ...
  @Mapping(
      target = "paymentAttributes.totalDirectAmortizationUnit",
      source = "totalDirectAmortizationUnit")
  @Mapping(target = "paymentAttributes.totalDirectAmortization", source = "totalDirectAmortization")
  @Mapping(
      target = "paymentAttributes.totalIndirectAmortizationUnit",
      source = "totalIndirectAmortizationUnit")
  @Mapping(
      target = "paymentAttributes.totalIndirectAmortization",
      source = "totalIndirectAmortization")
  ...
  @Mapping(
      target = "defaultSettlementAccount.internalId",
      source = "defaultSettlementAccountInternalId")
  @Mapping(
      target = "defaultSettlementAccount.externalId",
      source = "defaultSettlementAccountExternalId")
