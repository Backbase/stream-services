...
public class PlansService {
  ...
  public void init() {
    ...
    plansApi
        .getPlans(new HashSet<>(), new HashSet<>(), null)
  ...
  public Mono<Void> updateUserPlan(
      String internalUserId, UserPlanUpdateRequestBody userPlanUpdateRequestBody, String planName) {
    ...
    log.info(
        "Started ingestion of plans {} for user {}",
        userPlanUpdateRequestBody.getId(),
        internalUserId);
    return userPlansApi
        .updateUserPlan(internalUserId, userPlanUpdateRequestBody)
        .map(
